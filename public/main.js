...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("music", "sounds/theme1.ogg");
    ...
    this.load.audio("pickcoin", "endless_runner/sounds/pickCoin.wav");
    this.load.audio("explosion", "endless_runner/sounds/explode.wav");
    this.load.audio("killmissile", "endless_runner/sounds/killMissile.ogg");
  ...
  addHomeUI() {
    ...
    this.optionsContainer = this.add
      .rexRoundRectangle(400, 900, 570, 450, 50, 0x66a666)
      .setDepth(5)
      .setScrollFactor(0);
    ...
    this.option1 = this.add
      .rexRoundRectangle(400, 830, 470, 80, 50, 0xf3e3a3)
      .setDepth(5)
      .setScrollFactor(0)
      .setInteractive();
    ...
    this.option2 = this.add
      .rexRoundRectangle(400, 945, 470, 80, 50, 0xfaa7ab)
      .setDepth(5)
      .setScrollFactor(0)
      .setInteractive();
    ...
    this.option3 = this.add
      .rexRoundRectangle(400, 1060, 470, 80, 50, 0x4e316e)
      .setDepth(5)
      .setScrollFactor(0)
      .setInteractive();
  ...
  addRestartUI() {
                    ...
                    (data) => {
                      if (this.remember) {
                        ...
                        localStorage.setItem(
                          "cholitos-bird-game-username",
                          this.username
                        );
                        localStorage.setItem(
                          "cholitos-bird-game-email",
                          this.email
                        );
                        localStorage.setItem(
                          "cholitos-bird-game-news",
                          this.news
                        );
                        localStorage.setItem(
                          "cholitos-bird-game-remember",
                          this.remember
                        );
                      }
    ...
    this.termsText = this.add
      .text(
        400,
        1170,
        "Powered by Cholitos. By playing this game you accept these Terms & policies.",
        {
          fontFamily: "RakeslyRG",
          fontSize: "20px",
          color: "#000",
  ...
  createPlayer() {
    this.player = this.physics.add
      .sprite(150, this.scale.height - 500, "player")
      .setScale(0.45);
